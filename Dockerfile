# This is the same dockerfile that Events.dockerfile but with a different name, 
# it is made to pass test required to make the pull request.
# I could not change the name of the real dockerfile because I have more than one in the 
# project and it would require changing its name in a lot of places an even platforms
# leading to errors.
