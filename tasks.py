...
def uploadImageToGithub(c):
    ...
    c.run("docker push docker.pkg.github.com/carlos-el/eventpost-ccproject_events_container:latest")
    c.run("docker push docker.pkg.github.com/carlos-el/eventpost-ccproject_notifications_container:latest")
